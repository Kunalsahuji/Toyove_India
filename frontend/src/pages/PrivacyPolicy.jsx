...
export function PrivacyPolicy() {
  return (
    ...
    >
      ...
      <section className="space-y-4">
        <h3 className="text-xl font-grandstander font-bold text-[#333]">Information We Collect</h3>
      ...
      <section className="space-y-4">
        <h3 className="text-xl font-grandstander font-bold text-[#333]">How We Use Your Information</h3>
      ...
      <section className="space-y-4">
        <h3 className="text-xl font-grandstander font-bold text-[#333]">Third-Party Sharing</h3>
      ...
      <section className="space-y-4">
        <h3 className="text-xl font-grandstander font-bold text-[#333]">Your Rights</h3>
