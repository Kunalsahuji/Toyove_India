  ...
  return (
    ...
    >
      <section className="space-y-4">
        <h2 className="text-2xl font-grandstander font-bold text-[#333]">Shipping Methods & Delivery Times</h2>
        ...
        <div className="overflow-x-auto">
          <table className="w-full border-collapse border border-gray-200 rounded-lg overflow-hidden">
            <thead className="bg-[#F9EAD3]">
              <tr>
                <th className="border p-4 text-left font-grandstander">Shipping Method</th>
                <th className="border p-4 text-left font-grandstander">Estimated Delivery</th>
                <th className="border p-4 text-left font-grandstander">Cost</th>
              </tr>
            </thead>
            <tbody>
              <tr>
      ...
      <section className="space-y-4">
        <h3 className="text-xl font-grandstander font-bold text-[#333]">Tracking Your Order</h3>
      ...
      <section className="space-y-4">
        <h3 className="text-xl font-grandstander font-bold text-[#333]">Damaged Items in Transit</h3>
