...
export function ReturnPolicy() {
  return (
    ...
    >
      ...
      <section className="space-y-4">
        <h3 className="text-xl font-grandstander font-bold text-[#333]">How to Start a Return</h3>
      ...
      <section className="space-y-4">
        <h3 className="text-xl font-grandstander font-bold text-[#333]">Non-Returnable Items</h3>
      ...
      <section className="space-y-4">
        <h3 className="text-xl font-grandstander font-bold text-[#333]">Refund Process</h3>
