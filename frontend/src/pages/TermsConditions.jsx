...
export function TermsConditions() {
  return (
    ...
    >
      ...
      <section className="space-y-4">
        <h3 className="text-xl font-grandstander font-bold text-[#333]">Product Accuracy</h3>
      ...
      <section className="space-y-4">
        <h3 className="text-xl font-grandstander font-bold text-[#333]">User Accounts</h3>
