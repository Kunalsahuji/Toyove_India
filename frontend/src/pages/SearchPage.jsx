          ...
          <div className="flex flex-wrap justify-center gap-4">
            {['Dolls', 'Soft Toys', 'STEM Kits', 'Board Games'].map(cat => (
              <Link 
                key={cat} 
                to="/" 
                className="px-6 py-2 bg-white/30 border border-dashed border-[#333]/20 rounded-full font-bold text-[12px] tracking-widest text-[#333] hover:bg-[#E84949] hover:text-white transition-all uppercase"
              >
                {cat}
              </Link>
            ))}
