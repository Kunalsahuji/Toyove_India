      ...
      <div className="hdr-inner relative z-10 w-full h-full flex items-center">
        ...
        <div className="w-[100%] sm:w-[80%] md:w-[60%] lg:w-[50%] relative z-20 flex flex-col items-start text-left pointer-events-auto mt-[-15%] md:mt-0">
          ...
          <motion.div
            ...
            className="w-fit"
          >
            <Link to="/all-categories" className="py-3 px-8 md:py-4 md:px-12 lg:py-5 lg:px-16 bg-white text-[#222] font-bold text-[11px] md:text-sm lg:text-[14px] uppercase rounded-md hover:bg-gray-50 hover:scale-[1.02] active:scale-95 transition-all duration-300 shadow-md cursor-pointer tracking-[0.15em] inline-block">
              SHOP NOW
            </Link>
          </motion.div>
        </div>
