...
export const mainNavLinks = [
  ...
  { 
    ...
    mega: {
      type: 'master',
      sidebar: [
        { name: 'Musical Toys', id: 'musical' },
        { name: 'Learning & Educational Toys', id: 'educational' },
        { name: 'Soft Toys', id: 'soft' },
        { name: 'Indoor & Outdoor Play', id: 'indoor' },
        { name: 'Play Gyms & Playmats', id: 'playgyms' },
        { name: 'Sports & Games', id: 'sports' },
        { name: 'Role & Pretend Play Toys', id: 'role' },
        { name: 'Blocks & Construction Sets', id: 'blocks' },
        { name: 'Stacking Toys', id: 'stacking' },
        { name: 'Kids Puzzles', id: 'puzzles' },
        { name: 'Baby Rattles', id: 'rattles' },
        { name: 'Toys Cars Trains & Vehicles', id: 'vehicles' },
        { name: 'Dolls & Dollhouses', id: 'dolls' },
        { name: 'Push & Pull Along Toys', id: 'pushpull' },
        { name: 'Art Crafts & Hobby Kits', id: 'art' },
        { name: 'Board Games', id: 'boardlinks' },
        { name: 'Action Figures & Collectibles', id: 'figures' },
        { name: 'Radio & Remote Control Toys', id: 'rc' },
        { name: 'Bath Toys', id: 'bath' },
        { name: 'Toys Guns & Weapons', id: 'guns' },
        { name: 'RIDE-ONS & SCOOTERS', id: 'rideons' },
        { name: 'BOARD GAMES', id: 'boardgames' },
        { name: 'HOME PLAY ACTIVITIES', id: 'homeplay' }
      ]
    }
  },
  { name: 'MUSICAL TOYS', href: '/collections/musical-toys', mega: categoryData['Musical Toys'] },
  { name: 'LEARNING & EDUCATIONAL', href: '/collections/learning-educational', mega: categoryData['Learning & Educational Toys'] },
  { name: 'RIDE-ONS & SCOOTERS', href: '/collections/ride-ons-scooters', mega: categoryData['RIDE-ONS & SCOOTERS'] },
  { name: 'BOARD GAMES', href: '/collections/board-games', mega: categoryData['BOARD GAMES'] },
  { name: 'HOME PLAY ACTIVITIES', href: '/collections/home-play-activities', mega: categoryData['HOME PLAY ACTIVITIES'] },
